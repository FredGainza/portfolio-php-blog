      ...
      <div class="row">
        ...
        <div class="col-xl-8">
          ...
          <?php if (!empty($_SESSION['success'])) : ?>
            ...
            <div class="media mb-4">
              <img class="d-flex mr-3 rounded-circle" src="<?= $_SESSION['log_avatar']; ?>" alt="">
            ...
            <div class="card gedf-card mb-3">
              <div class="card-header">
                <div class="d-flex justify-content-between align-items-center">
                  <div class="d-flex justify-content-between align-items-center">
                    <div class="mr-2">
                      <img class="rounded-circle" width="45" src="<?= $v->avatar; ?>" alt="">
                    </div>
                    <div class="ml-2">
                      <?php
                        $role = $v->role;
        ...
        <div class="col-xl-4">
          ...
          <div class="card my-4">
            ...
            <div class="card-body">
              <div class="input-group">
                <form action="result_search.php" method="POST" class="form-inline w-100">
                  <div class="form-group flexGrow-2 my-auto">
                  <input type="text" class="form-control w100grow" placeholder="Je cherche..." name="search">
                  </div>
                  <div class="input-group-btn my-auto">
                    <button class="btn btn-sm btn-dark ml-3" type="submit" name="sub_search" value="search_ok">Go!</button>
                  </div>
                </form>
              </div>
            </div>
          ...
          <div class="card my-4">
            ...
            ?>
 <h6 class="color-red-cay"><<?php echo $res_cit_ok->quote; ?></h6>
            </div>
          ...
          <div class="card my-4">
            ...
            <div class="card-body">
              ...
              <a href="https://kopatik.wixsite.com/kopa/" target="_blank"><img src="images/kopa_logo_bg_transparent.png" alt=""></a>
            </div>
          </div>
