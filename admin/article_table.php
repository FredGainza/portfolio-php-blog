    ...
    <table class="my-3 w-100 table-striped">
      <thead>
        <tr>
          ...
          <th>Date création</th>
          <th>Lecture</th>
          <th class="text-center mx-1">Actions</th>
        </tr>
      </thead>
        ...
        <?php foreach ($res_aut as $value) : ?>
          ...
          <tr>
            ...
            <td class="text-center">
              ...
              <a href="?article=delete&id=<?= $value->id ?>" class="delete" title="Delete" onclick="return confirm('Etes-vous certain de votre choix ?')"><i class="material-icons color-red"></i></a>
            </td>
          </tr>
        <?php endforeach ?>
      </tbody>
